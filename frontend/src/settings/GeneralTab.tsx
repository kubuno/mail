...
import { DEFAULT_PREFS, DEFAULT_TEXT_STYLE, loadPrefs, type MailPrefs, type VacationResponder } from './prefs'
// Kept re-exported: the composer and the reader import these from here today.
export { DEFAULT_PREFS, DEFAULT_TEXT_STYLE, loadPrefs }
export type { MailPrefs, VacationResponder }
