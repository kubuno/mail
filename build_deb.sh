...
#   /usr/lib/kubuno/modules/mail/{kubuno-mail, module.toml, frontend/}
#   /usr/share/kubuno/modules/mail/migrations/*.sql
#   /etc/kubuno/modules/mail/config.toml.example
#
# Usage :
...
Depends: libssl3, ca-certificates, kubuno-core (>= 0.1.0)
Section: web
Priority: optional
Homepage: https://github.com/kubuno/${MODULE}
Description: Kubuno Mail — module de messagerie IMAP/SMTP (build ${BUILD_NUM})
EOF
